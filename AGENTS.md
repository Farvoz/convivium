...
- `docs\Правила игры.md` - здесь содержатся изначальные правила игры;
- `docs\Требования к UI.md` - описание желаемого визуала;
- `docs\Исправить.md` - дальнейшие шаги для разработки;
...
HTML + CSS современных версий. По максимуму использовать существующие переменные и понятия.
